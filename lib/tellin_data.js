...
DataItem.prototype={
	...
	_getDate:function(pdate){
		var date = pdate || this.Info.birthtime,
	...
	_getYamlInfo:function(data){
		...
		if(typeof _yaml.Date !== 'string' && typeof _yaml.Date!='undefined'){
			_yaml.Date = this._getDate(_yaml.Date);
			//console.log(_yaml.Title,_yaml.Date,typeof _yaml.Date,this._getDate(_yaml.Date));		
		}
		//this.Content
	...
	_ready:function(){
		//console.log('@@@@@@@@@');
		//console.log(this.RenderData.Date);
